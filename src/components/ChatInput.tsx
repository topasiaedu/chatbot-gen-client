...
import { PRESET_QUESTIONS, QuestionCategory, PresetQuestion } from "../constants/presetQuestions";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full px-4 pb-2 flex justify-end">
  <button
    type="button"
    onClick={togglePresetQuestions}
    className="flex items-center gap-2 px-4 py-2 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 hover:bg-orange-200 dark:hover:bg-orange-900/50 transition-colors duration-200 text-sm font-medium"
  >
